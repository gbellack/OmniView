...
//extern void InitializeDisplay(int8_t SID, int8_t SCLK, int8_t DC, int8_t RST, int8_t CS);
//
//// EFFECTS:
//extern void begin(uint8_t switchvcc = SSD1306_SWITCHCAPVCC, uint8_t i2caddr = SSD1306_I2C_ADDRESS, bool reset=true);
